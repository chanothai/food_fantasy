package onedaycat.com.food_fantasy.ui.mainfood.fragment
    ...
    private fun foodDataObserver() {
        foodViewModel.foodData.observe(this, Observer { data ->
            ...
            data?.let {
                ...
                rv_with_refresh.layoutManager = LinearLayoutManager(context)
                rv_with_refresh.hasFixedSize()
                rv_with_refresh.adapter = foodAdapter
            }
